...
public class NGram_Type extends QAAnnotation_Type {
   ...
   */
  @SuppressWarnings("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f13.hw1.sji.NGram");
  ...
  public int getElements(int addr) {
      ...
      jcas.throwFeatMissing("elements", "edu.cmu.lti.f13.hw1.sji.NGram");
  ...
  public String getElementType(int addr) {
      ...
      jcas.throwFeatMissing("elementType", "edu.cmu.lti.f13.hw1.sji.NGram");
